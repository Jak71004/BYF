(function(){
    ...
    var wgrFactoryVar = function($http){
        ...
        wgrFactory.prototype.payOut = function(){
            var self = this;
            
            return $http.post('http://betyoufailapi-betyoufail.rhcloud.com/api/payout', self)
        ...
        wgrFactory.prototype.saveWager = function(){
            var self = this;
            return $http.post('http://betyoufailapi-betyoufail.rhcloud.com/api/wagers/wager', self )
                .then(function(response){
        ...
        wgrFactory.prototype.getWagers = function(){
            ...
            return $http.get('http://betyoufailapi-betyoufail.rhcloud.com/api/wagers')
                .then(function(response){
                    return response.data;
                });
        };
        ...
        wgrFactory.prototype.getWager = function(email, publicAddress){
            ...
            return $http.get('http://betyoufailapi-betyoufail.rhcloud.com/api/wagers/wager', config)
                .then(function(response){
                    self.email = response.data.email;
                    self.amount = response.data.amount;
                    self.amountBTC = response.data.amountBTC;
...
//        btcFactory.getBalance(btcFactory.address).then(function(){$scope.balance = btcFactory.balance;});
        ...
        $scope.UpdateBTC = function(){
            ...
            myWagerFactory.saveWager().then(function(res){$scope.btcAddress= res.publicAddress;});
            //$scope.btcAddress= myWagerFactory.publicAddress; //btcFactory.address;
            //myWagerFactory.publicAddress = btcFactory.address;
            
        };
        
        $scope.WagerSuccess = function(){
            myWagerFactory.payOut().then(function(res){$scope.txHash = res.txHash;});
        };
