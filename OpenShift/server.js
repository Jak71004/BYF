...
var SampleApp = function() {
    ...
    self.initializeServer = function() {
        ...
        self.app
            .post('/api/payout', function(req, res){
                var txHash = bitcoinCtrl.SendTranasction(req.body);
                res.send(req.body)
        })
            ...
            .get('/api/wagers', function(req, res){
                console.log('You rang? ' + bitcoinCtrl.CreateKeyPair().getAddress());
                res.send({email:'jon'}); 
        })
            .get('/api/wagers/wager', function(req, res){
                console.log('You rang?' + req.query.email);
                res.json({
                    email:'jon@me.com',
                    proposition: 'stuff',
                    duration: '1 week',
